...
VALUES ('a0000000-0000-0000-0000-000000000001', 'Sunset Apartments', '123 Main St, Springfield, IL')
ON CONFLICT DO NOTHING;

INSERT INTO buildings (id, property_id, name)
VALUES ('b0000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000001', 'Building A')
ON CONFLICT DO NOTHING;

INSERT INTO units (id, building_id, unit_number)
VALUES ('u0000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000001', '101')
ON CONFLICT DO NOTHING;
